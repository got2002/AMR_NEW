<template>
	<div id="org-form-data" class="grid grid-cols-12 gap-4 bg-white shadow-sm rounded p-4 text-sm">
		...
		<div class="col-span-4">
			...
			<div class="border border-gray-300">
				<UIDropdownSearch v-model="form.province" @input="getDistrict" :disabled="!edit" :options="dropdowns.provinces" valueAttr="value" textAttr="text" :searchable="true" />
			</div>
		...
		<div class="col-span-4">
			...
			<div class="border border-gray-300">
				<UIDropdownSearch v-model="form.district" @input="getSubdistrict" :disabled="dropdowns.district.length === 0 && !edit" :options="dropdowns.district" valueAttr="value" textAttr="text" :searchable="true" />
			</div>
