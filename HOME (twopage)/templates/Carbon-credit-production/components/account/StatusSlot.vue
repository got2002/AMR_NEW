<template>
	<td
		class="border-t-0 px-1 whitespace-nowrap align-center"
		:class="{
	...
	>
		<span class="px-3 py-1 rounded-full shadow-sm" :class="{
            'bg-yellow-500':status === 0,
            'bg-blue-500':status === 1,
            'bg-green-500 text-white':status === 2,
            'bg-red-500 text-white':status === 3 || status === 5,
            'bg-gray-500':status === 4,
