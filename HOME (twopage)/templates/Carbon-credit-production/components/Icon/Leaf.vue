<template>
	<svg :fill="color" width="52" height="52" version="1.1" id="lni_lni-leaf" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" style="enable-background: new 0 0 64 64" xml:space="preserve">
		<path
			d="M61.6,58.2l-13-12.9c3-3.7,4.5-8.1,4.5-12.9c0-7.1-3.5-14.5-9.9-20.8C26.6-5,6,4.9,5.8,5L5.2,5.3L4.8,6
