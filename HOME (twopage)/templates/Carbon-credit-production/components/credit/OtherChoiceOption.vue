<template>
	<div id="further" class="space-y-2">
		<div class="flex items-center gap-2">
			...
			<input v-if="model.option === 'otherPurpose'" v-model="model.other_purpose" placeholder="text your purpose here..." class="border-b outline-none bg-white text-blue-500 " />
		</div>
