<template>
	<div class="grid grid-cols-12 gap-2 p-4">
		...
		<div class="xl:col-span-3 lg:col-span-3 md:col-span-6 col-span-12 relative">
			...
			<UIRangeSlider ref="slider-range" :min="1" :max="limit.maxBlocks" :minRangeValue="filter.min" :maxRangeValue="filter.max" @setMin="filter.min = Number($event)" @setMax="filter.max = Number($event)" />
		</div>
		<div class="xl:col-span-3 lg:col-span-3 md:col-span-6 col-span-12">
		...
		<div class="xl:col-span-3 lg:col-span-8 col-span-8">
			<UILabel :text="$t('project.table.filter.label.Cooperative Approach')" />
		...
		<div class="xl:col-span-4 lg:col-span-8 col-span-8">
