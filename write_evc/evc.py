...
def read_data():
    ...
    for i in range(quantity):
        # Assuming data is provided as a list in the form
        # data_0, data_1, ..., data_quantity-1
    ...
    return render_template('evc.html',  slave_id=slave_id, function_code=function_code,values=values,
                           starting_address=starting_address, quantity=quantity, is_16bit=is_16bit, communication_traffic=communication_traffic, tables=[df.to_html(classes="data")],
...
def Manualpoll_data():
    ...
    return render_template(
        ...
        tag_options=tag_options,
        run_options=run_options,
        df=df,slave_id=0, function_code=0, starting_address=0, quantity=0, data_list=[], is_16bit=False, communication_traffic=communication_traffic
    )
