...
write_evc = Blueprint('write', __name__)

write_evc.secret_key = "your_secret_key_here"
...
def write():
    with connect_to_amr_db() as amr_connection:
        ...
        run_results = fetch_data(amr_connection,run_query, params={"tag_id": selected_tag})
...
def read_data():
        ...
        return render_template('write_evc.html',   df=df,
        slave_id=slave_id,
...
@write_evc.route("/get_tags", methods=["GET"])
def get_tags():
    with connect_to_amr_db() as amr_connection:
        print("Active Connection:", active_connection)
...
@write_evc.route("/get_runs", methods=["GET"])
def get_runs():
    with connect_to_amr_db() as amr_connection:
        print("Active Connection:", active_connection)
