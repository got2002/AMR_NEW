...
logging.basicConfig(filename='C:\\Users\\Administrator\\Desktop\\Autopoll\\Actaris(G3).log', level=logging.ERROR, format='%(asctime)s - %(levelname)s: %(message)s')
query = """
            SELECT
